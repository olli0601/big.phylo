...
#######################################################
 -exe=BOOTSTRAPSEQ -resume=0 -bootstrap=0 -by=codon -indir=/Users/Oliver/git/big.phylo/pkg/example -infile=nz_h3n2 -outdir=/Users/Oliver/git/big.phylo/pkg/example
#######################################################
...
/Users/Oliver/Library/R/2.15/library/big.phylo/ext/ExaML-parsimonator -p51831 -s /Users/Oliver/git/big.phylo/pkg/example/nz_h3n2.phylip.000 -n nz_h3n2.starttree.000 
