...
#######################################################
/Users/Oliver/Library/R/2.15/library/big.phylo/misc/startme.R -exe=BOOTSTRAPSEQ -resume=0 -bootstrap=2 -by=codon -indir=/Users/Oliver/git/big.phylo/pkg/example -infile=nz_h3n2 -outdir=/Users/Oliver/git/big.phylo/pkg/example
#######################################################
...
[ -s /Users/Oliver/git/big.phylo/pkg/example/ExaML_result.nz_h3n2.finaltree.002 ] && [ -s /Users/Oliver/git/big.phylo/pkg/example/ExaML_info.nz_h3n2.finaltree.002 ] && exit 1
CWDEXAML=$(pwd)
cd /Users/Oliver/git/big.phylo/pkg/example
/Users/Oliver/Library/R/2.15/library/big.phylo/ext/ExaML-parser -m DNA -s /Users/Oliver/git/big.phylo/pkg/example/nz_h3n2.phylip.002 -n nz_h3n2.phylip.examl.002 
...
/Users/Oliver/Library/R/2.15/library/big.phylo/ext/ExaML-parsimonator -p15034 -s /Users/Oliver/git/big.phylo/pkg/example/nz_h3n2.phylip.002 -n nz_h3n2.starttree.002 
...
mpirun -np 1 /Users/Oliver/Library/R/2.15/library/big.phylo/ext/examl -m GAMMA -D -s nz_h3n2.phylip.examl.002.binary -t RAxML_parsimonyTree.nz_h3n2.starttree.002.0 -n nz_h3n2.finaltree.002 
echo 'end /Users/Oliver/Library/R/2.15/library/big.phylo/ext/examl' 
echo 'start cleanup'
find . -name '*phylip.002*' -delete
find . -name '*phylip.examl.002*' -delete
find . -name '*starttree.002*' -delete
find . -name 'ExaML_binaryCheckpoint.*?finaltree.002*' -delete
find . -name 'ExaML_log.*?finaltree.002*' -delete 
echo 'end cleanup'
cd $CWDEXAML
#######################################################
